...
// Actualización y eliminación de vuelos
Route::get('/vuelos/editar', [VueloController::class, 'edit'])->name('editarVuelo'); // Ver formulario para editar
Route::put('/vuelos/{id}', [VueloController::class, 'update'])->name('actualizarVuelo'); // Actualizar vuelo
Route::delete('/vuelos/{id}', [VueloController::class, 'destroy'])->name('eliminarVuelo');
Route::get('/vuelos/gestionar', [VueloController::class, 'gestionarVuelos'])->name('gestionarVuelos');
